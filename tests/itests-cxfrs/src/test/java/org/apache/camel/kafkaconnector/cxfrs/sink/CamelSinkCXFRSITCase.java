...
public class CamelSinkCXFRSITCase extends AbstractKafkaTest {
    private static final Logger LOG = LoggerFactory.getLogger(CamelSinkCXFRSITCase.class);
    ...
    public void testBasicSendReceiveUsingUrl() {
        try {
            ...
            ConnectorPropertyFactory connectorPropertyFactory = CamelSinkCXFRSPropertyFactory.basic()
